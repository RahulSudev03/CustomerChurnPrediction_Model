...
voting_classifier_model = load_model("voting_clf (1).pkl")
...
def explain_prediction(input_dict,probability,surname):
  ...
  Your machine learning model has predicted that a customer named {surname} has a {round(probability*100,1)}% probability of churning, based on the information provided below.
    ...
    - If customer has over a 40% risk of churning, generate a 3 sentence explanation of why they are at risk.
    - If they have less than 40%, generate a 3 sentence explanation of why they migh not be at risk of churning.
...
-Just Return the three line explanation and nothing else. DO NOT MENTION THE PROBABILITY OF CHURNING. Also do not mention the threshold of 40% anywhere
...
def generate_email(probability, input_dict,explanation, surname):
  ...
  Generate an email to the customer based on thei information, asking them to stay if they are at risk of churning, or offering them incentives so that they become more loyal to the bank
  Make sure to list out a set of incentives to stay based on their information, in bullet point format. Dont't ever mention the probability of churning, or the machine learning model to the customer"""
...
if selected_customer_option:
  ...
  print("Selcted Customer", selected_customer)
